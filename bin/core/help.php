			...
			return array(
				...
				"help" => array(
					"welcome" => array(
						...
						"URL" => "/",
						"response" => "{\"code\": <code_code>, \"message\": <random_welcome_message>}",
						"notes" => "Basic request"
					),
					"help" => array(
						"name" => "Help",
						...
						"URL" => "/",
						"response" => "{\"code\": <code_code>, \"message\": <help_generic_message>, \"help\": {<REST_command_name>: {\"name\": <REST_command_name>, \"type\": <GET_or_POST>, \"action\": <functionality>, \"request\": <request_structure>, \"URL\": <REST_URL>, \"response\": <response_structure>, \"notes\": <description>}, ...}}",
					...
					"auth" => array(
						...
						"URL" => "/",
						"response" => "{\"code\": <code_code>, \"message\": <ok_or_error_message>, \"sub_info\": {\"name\": <sub_name>, \"active\": <true/false>, \"super\": <true/false>, \"max\": {\"day\": <max_usages_for_day>, \"h\": <max_usages_for_hour>, \"m\": <max_usages_for_minute>}, \"remaining\": {\"day\": <remaining_usages_for_day>, \"h\": <remaining_usages_for_hour>, \"m\": <remaining_usages_for_minute>}}}",
