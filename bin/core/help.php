		...
		return array(
			...
			"help" => array(
				...
				"create_server" => array(
					"name" => "Create Server",
					"type" => "POST",
					"action" => "Permits to add a server to valid ones",
					"request" => "{\"request\": \"create_server\", payload: {\"token\": <GitHub_token>, \"username\": <GitHub_username>, \"serverName\": <serverName>, \"serverPassword\": <serverPassword>, \"server_description\": <server_description>, \"server_public_key\": <server_public_key>}",
					"URL" => "/",
					"response" => "{\"code\": <code>, \"message\": <response_message>}",
					"notes" => "This REST API call permits to add a server to valid ones, so it can start to contribute to the project"
				),
				"server_reserve_job" => array(
					"name" => "Reserve a new repo to create (server-side)",
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_reserve_job\", \"serverName\": <serverName>, \"serverPassword\": <serverPassword>}",
					"URL" => "/",
				...
				"server_get_job_info" => array(
					...
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_get_job_info\", \"serverName\": <serverName>, \"serverPassword\": <serverPassword>, \"repoID\": <repoID>}",
					"URL" => "/",
				...
				"server_set_job_done" => array(
					...
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_set_job_done\", \"serverName\": <serverName>, \"serverPassword\": <serverPassword>, \"repoID\": <repoID>}",
					"URL" => "/",
					"response" => "{\"code\": <code>, \"message\": <response_message>}",
				...
				"server_set_priority" => array(
					...
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_set_priority\", \"username\": <GitHub_username>, \"token\": <Github_token>, \"serverName\": <serverName>, \"server_priority\": <server_priority>}",
					"URL" => "/",
					"response" => "{\"code\": <code>, \"message\": <response_message>}",
				...
				"server_get_priority" => array(
					...
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_get_priority\", \"serverName\": <serverName>, \"serverPassword\": <serverPassword>}",
					"URL" => "/",
				...
				"server_set_priority_done" => array(
					...
					"type" => "POST",
					"action" => "functionality",
					"request" => "{\"request\": \"server_set_priority_done\", \"serverName\": <serverName>, \"serverPassword\": <serverPassword>, \"priorityID\": <priorityID>}",
					"URL" => "/",
					"response" => "{\"code\": <code>, \"message\": <response_message>}",
